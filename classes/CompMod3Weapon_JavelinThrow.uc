...
class CompMod3Weapon_JavelinThrow extends AOCWeapon_JavelinThrow;
...
DefaultProperties
{
	...
	AttachmentClass=class'CompMod3WeaponAttachment_JavelinThrow'
	...
	AlternativeMode=class'CompMod3Weapon_JavelinMelee'
