...
*/
class CompMod3WeaponAttachment_Brandistock extends AOCWeaponAttachment_Brandistock;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'CompMod3Weapon_Brandistock'
	...
	AttackTypeInfo(2)=(fBaseDamage=61.0, fForce=27000, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
