...
*/
class CompMod3Weapon_BeardedSword extends AOCWeapon_Longsword;
...
DefaultProperties
{
	...
	AttachmentClass=class'CompMod3WeaponAttachment_BeardedSword'
	...
	AlternativeMode=class'CompMod3Weapon_Bearded'
