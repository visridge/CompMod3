...
* Crossbow.
*/
class CompMod3Weapon_Crossbow extends CompMod3RangeWeapon;
...
DefaultProperties
{
	...
	AttachmentClass=class'CompMod3WeaponAttachment_Crossbow'
	...
	WeaponProjectiles(0)=class'CompMod3Proj_SteelBolt'
