...
*/
class CompMod3Weapon_ShortSpearMelee extends AOCWeapon_ShortSpearMelee;
...
DefaultProperties
{
	...
	AttachmentClass=class'CompMod3WeaponAttachment_ShortSpear'
	...
	bCanDodge=false
	AlternativeMode=class'CompMod3Weapon_ShortSpearThrow'
