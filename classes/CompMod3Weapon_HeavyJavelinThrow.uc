...
class CompMod3Weapon_HeavyJavelinThrow extends AOCWeapon_HeavyJavelinThrow;
...
DefaultProperties
{
	...
	AttachmentClass=class'CompMod3WeaponAttachment_HeavyJavelinThrow'
	...
	AlternativeMode=class'CompMod3Weapon_HeavyJavelinMelee'
