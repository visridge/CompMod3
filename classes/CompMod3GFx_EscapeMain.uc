...
*/
class CompMod3GFx_EscapeMain extends AOCGFx_ViewManager;
...
var CompMod3View_Frontend_Customization  NewCustomizationOpView;
...
{    
	...
	//LogAlwaysInternal("CompMod3GFx_EscapeMain::WidgetInitialized"@Widget);
    ...
    {           
		case ('Customization'):
			...
			{
				NewCustomizationOpView = CompMod3View_Frontend_Customization(Widget);
...
{
	//LogAlwaysInternal("CompMod3GFx_EscapeMain::LoadViewByName"@InputName);
	switch (InputName)
	{
	case "ConfigMain":
...
defaultproperties
{
	...
	WidgetBindings.Add((WidgetName="Customization",WidgetClass=class'CompMod3View_Frontend_Customization'))
