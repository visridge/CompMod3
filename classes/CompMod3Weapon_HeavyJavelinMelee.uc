...
*/
class CompMod3Weapon_HeavyJavelinMelee extends AOCWeapon_HeavyJavelinMelee;
...
DefaultProperties
{
	...
	AttachmentClass=class'CompMod3WeaponAttachment_HeavyJavelin'
	...
	bCanDodge=false
	AlternativeMode=class'CompMod3Weapon_HeavyJavelinThrow'
