...
static function int GetDefaultCharacterIDFor(int Team, int PawnClass)
{
    ...
    case ECLASS_Vanguard:
        return Team == EFAC_Agatha ? default.Characters.Find(class'AOCCharacterInfo_Agatha_Vanguard') : default.Characters.Find(class'AOCCharacterInfo_Mason_Vanguard');
        break;
    case ECLASS_Knight:
        return Team == EFAC_Agatha ? default.Characters.Find(class'AOCCharacterInfo_Agatha_Knight') : default.Characters.Find(class'AOCCharacterInfo_Mason_Knight');
        break;
    case ECLASS_King:
        return Team == EFAC_Agatha ? default.Characters.Find(class'AOCCharacterInfo_King') : default.Characters.Find(class'AOCCharacterInfo_King');
        break;
    case ECLASS_Peasant:
    default:
...
defaultproperties
{
	...
	Characters.Add(class'AOCCharacterInfo_King')
	Characters.Add(class'AOCCharacterInfo_Agatha_Knight')
	Characters.Add(class'AOCCharacterInfo_Agatha_ManAtArms')
	Characters.Add(class'AOCCharacterInfo_Agatha_Vanguard')
	Characters.Add(class'AOCCharacterInfo_Mason_Archer')
	Characters.Add(class'AOCCharacterInfo_King')
	Characters.Add(class'AOCCharacterInfo_Mason_Knight')
	Characters.Add(class'AOCCharacterInfo_Mason_ManAtArms')
	Characters.Add(class'AOCCharacterInfo_Mason_Vanguard')
	...
	Characters.Add(class'AOCCharacterInfo_Archer')
	Characters.Add(class'AOCCharacterInfo_BARB_Agatha_Knight')
	Characters.Add(class'AOCCharacterInfo_ManAtArms')
	Characters.Add(class'AOCCharacterInfo_Vanguard')
	Characters.Add(class'AOCCharacterInfo_Archer')
	Characters.Add(class'AOCCharacterInfo_BARB_Mason_Knight')
	Characters.Add(class'AOCCharacterInfo_ManAtArms')
	Characters.Add(class'AOCCharacterInfo_Vanguard')
    ...
    Teams.Empty()
    Teams.Add(class'CompMod3CustomizationTeam_Agatha') //0
    Teams.Add(class'CompMod3CustomizationTeam_Mason') // 1
    Teams.Add(class'CompMod3CustomizationTeam_FFA') //5
