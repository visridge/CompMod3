class CompMod3RangeWeapon extends AOCRangeWeapon;
...
simulated function ChangeProjectileType(class<AOCProjectile> Proj) {
	...
	if (class<CompMod3Weapon_Crossbow>(Class) != none && AOCOwner.PawnInfo.myTertiary == class'AOCWeapon_ExtraAmmo')
...
simulated state Active {
	simulated function BeginFire(byte FireModeNum) {
		...
		else if (bLoaded || (FireModeNum == Attack_Overhead && CompMod3Weapon_Crossbow(self) != none))
