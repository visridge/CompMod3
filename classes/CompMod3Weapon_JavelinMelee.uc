...
*/
class CompMod3Weapon_JavelinMelee extends AOCWeapon_JavelinMelee;
...
DefaultProperties
{
	...
	AttachmentClass=class'CompMod3WeaponAttachment_Javelin'
	...
	bCanDodge=false
	AlternativeMode=class'CompMod3Weapon_JavelinThrow'
